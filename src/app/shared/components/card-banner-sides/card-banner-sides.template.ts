  ...
  template: `
    ...
    <app-card>
      <div
        ...
        [class.bg-primary]="isPrimary() || !isSecondary()"
      ...
      <div class="flex-1 min-h-[300px] md:min-h-[400px]" [style.order]="imagePosition() === 'right' ? 2 : 1">
...
export class CardBannerSidesTemplate {
  public imagePosition = input<'left' | 'right'>('right');
